...
export const metadata: Metadata = {
  ...
  description: "Explore a curated directory of beginner-friendly open-source programs, internships, and contribution opportunities.",
  keywords: [
    "owasp tiet",
  ...
  openGraph: {
    ...
    description: "Browse active open source programs and opportunities to kickstart your journey into open source development.",
